            ...
            <div class="row">
               ...
               <div class="col s12 l9">
                   ...
                   <div class="card-content">
                     ...
                     <div class="row">
                       ...
                       <div class="input-field col s3">
                         <input type="text" name="remarks" id="remarks" class="validate" />
                           ...
                           <td>
                            <?=$bill['title']?> - <?=$bill['remarks']?>
                             <?php if ($bill['service_cat'] == 'clinic'): ?>
                               <a href="#serv<?=$bill['id']?>" class="modal-trigger">[<i class="mdi-action-delete tiny"></i>]</a>
                             <?php endif ?>
                           </td>
                           <td><?=$bill['amount']?></td>
                           <td>
                ...
                <?php if ($billing_items):?>
                  <?php foreach ($billing_items as $bill): ?>
                    <div id="serv<?=$bill['id']?>" class="modal">
                      <?=form_open('billing/remove_service')?>
                          <div class="modal-content">
                            <h5 class="header">Remove Service?</h5><!-- /.header -->
                            <p>Are you sure to remove <span class="strong red-text"><?=$bill['title']?></span> in Billing #<?=prettyID($info['id'])?></p>
                            <div class="row">
                          ...
                          <div class="modal-footer grey darken-4">
                            ...
                            <button type="submit" class="waves-effect waves-red btn red modal-action">Remove</button>
                          </div>
                      <?=form_close()?>
                    </div>
                  <?php endforeach ?>    
                ...
                <div class="modal-content">
                    ...
                    <div class="row">
                      <div class="col s12">
                        ...
                        <textarea name="remarks" id="remarks" cols="30" rows="10" class="ckeditor"><?=$info['remarks']?></textarea>
                      </div><!-- /.col s12 -->                     
                    </div><!-- /.row -->
                    <input type="hidden" name="id" value="<?=$this->encryption->encrypt($info['id'])?>" />
                  </div>
              ...
              <?=form_open('billing/add_payment')?>
                <div class="modal-content">
                    ...
                    <div class="row">
                      <div class="col s12">
                        <label>Remarks</label>
                        <textarea name="remarks" id="description" cols="30" rows="10" class="ckeditor"></textarea>
                      </div><!-- /.col s12 -->                     
                    </div><!-- /.row -->
                    <input type="hidden" name="id" value="<?=$this->encryption->encrypt($info['id'])?>" />
                  </div>
